...
public final class CameraConfiguration {
    ...
    public interface Arguments {
        String MEDIA_ACTION = "com.library.camlibrary.media_action";
        String MEDIA_QUALITY = "com.library.camlibrary.camera_media_quality";
        String VIDEO_DURATION = "com.library.camlibrary.video_duration";
        String MINIMUM_VIDEO_DURATION = "com.library.camlibrary.minimum.video_duration";
        String VIDEO_FILE_SIZE = "com.library.camlibrary.camera_video_file_size";
        String FILE_PATH = "com.library.camlibrary.camera_video_file_path";
        String FLASH_MODE = "com.library.camlibrary.camera_flash_mode";
        String SHOW_PICKER = "com.library.camlibrary.show_picker";
        String PICKER_TYPE = "com.library.camlibrary.picker_type";
        String ENABLE_CROP = "com.library.camlibrary.enable_crop";
        String AUTO_RECORD = "com.library.camlibrary.auto_record";
    }
