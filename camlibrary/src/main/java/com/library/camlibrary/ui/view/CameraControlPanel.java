package com.library.camlibrary.ui.view;
...
import com.library.camlibrary.utils.DateTimeUtils;
...
public class CameraControlPanel extends RelativeLayout
    ...
    private ImageButton settingsButton, pickerButton;
    ...
    private void init() {
        ...
        pickerButton = (ImageButton) findViewById(R.id.photo_gallery_picker);
    ...
    public void showPicker(boolean isShown) {
        ...
        pickerButton.setVisibility(isShown ? VISIBLE : GONE);
    ...
    public void onStopVideoRecord() {
        ...
        pickerButton.setVisibility(VISIBLE);
    ...
    public void onStartRecordingButtonPressed() {
        ...
        pickerButton.setVisibility(GONE);
